    ...
    <div class="px-5 py-6">
        ...
        <div class="md:flex md:justify-between md:items-center">
            ...
            <div class="flex items-center mb-4 md:mb-0">
                <!-- Avatar -->
                <div class="mr-4">
                    <img class="inline-flex rounded-full" src="{{ asset('images/user.png') }}" width="64" height="64" alt="User" />
                </div>
                <!-- User info -->
                <div class="">
                    <div class="mb-2">Hey <strong class="font-medium text-slate-800">{{ $loggedUser->name }}</strong> 👋, this is your current balance:</div>
                    <div class="text-3xl font-bold text-emerald-500">{{ $loggedUser->account_balance }}</div>
                    ...
                    <a href="/users/{{ $loggedUser->id }}/withdraw" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                        ...
                        <span class=" xs:block ml-2">Withdraw</span>
                    </a>
                </div>
