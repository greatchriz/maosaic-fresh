{{-- if the authenticated user has no card you should see this --}}
@if(!$loggedUser->hasCard())
    <div class="flex flex-col col-span-full xl:col-span-4 bg-indigo-200 shadow-lg rounded-lg ">

        <!-- Alert -->
        <div class="relative  rounded-sm p-5 min-w-60 mb-5">
...
{{-- if authenticated user has a card you should see active cards --}}
@if($loggedUser->hasCard())
        ...
        <div class="h-full flex flex-col px-5 py-6">
            ...
            <div class="relative w-full max-w-sm mx-auto bg-slate-800 p-3 rounded-2xl">
                ...
                <div
                    ...
                    <!-- Gradients -->
                    <div
                        class="absolute left-0 -bottom-1/3 w-[398px] aspect-square"
                        aria-hidden="true"
                    >
                        <svg
                            class="w-full h-full"
                        ...
                        >
                            ...
                            <circle
                                class="fill-indigo-100 opacity-60"
                                filter="url(#glow-a)"
                                cx="85"
                                cy="85"
                                r="85"
                    ...
                    <div
                        class="absolute right-0 -top-1/3 w-[398px] aspect-square"
                        aria-hidden="true"
                    >
                        <svg
                            class="w-full h-full"
                ...
                <div class="space-y-2">
                    <div>
                        ...
                        <div class="relative w-full h-2 bg-slate-600">
                            <div
                                class="absolute inset-0 bg-emerald-500"
                                aria-hidden="true"
                                style="width: 50%;"
                            ></div>
                        </div>
