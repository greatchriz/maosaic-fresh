<div class="bg-white shadow-lg rounded-sm border border-slate-200">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-slate-800">All users <span class="text-slate-400 font-medium">{{ 20 }}</span></h2>
    </header>
                ...
                <tbody class="text-sm divide-y divide-slate-200">
                    ...
                    @foreach($users as $user)
                        <tr>
                            ...
                            {{-- <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 shrink-0 mr-2 sm:mr-3">
                                        <img class="rounded-full" src="{{ asset('images/' . $user->image) }}" width="40" height="40" alt="{{ $user->name }}" />
                                    </div>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="text-left font-medium text-sky-500">last order</div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="text-left font-medium text-emerald-500">spent</div>
                            </td>
                            {{-- <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
