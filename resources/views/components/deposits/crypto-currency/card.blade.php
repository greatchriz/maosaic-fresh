<div class="bg-white p-5 shadow-lg rounded-sm border border-slate-200 lg:w-72 xl:w-80">
    ...
    <!-- Header -->
    <div class="text-slate-800 text-sm font-semibold mb-2">To complete your transaction you have to Copy the the <br> TRC 20
        wallet
        Above and go to any crypto wallet of your choice and make the payment of the amount that you want to deposit to
        your wallet. Then you copy the transaction hash of your transaction and paste it below.</div>
    <!-- Order details -->
