        ...
        * {
        ...
        @media (max-width: 480px) {
            ...
            #u_content_image_3 .v-container-padding-padding {
                padding: 70px 30px 10px 10px !important;
            }
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row no-stack"
                            ...
                            <div
                                ...
                                <div class="u-col u-col-58p17"
                                    style="max-width: 320px;min-width: 349.02px;display: table-cell;vertical-align: top;">
                                    <div
                                        ...
                                        <div
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:60px 30px 5px;font-family:'Open Sans',sans-serif;"
                                                            align="left">

                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 32px; ">
                                                                Attempts to<br />Resolve The<strong> Issue</strong></h1>
                                            ...
                                            <table id="u_content_divider_2" style="font-family:'Open Sans',sans-serif;"
                                                role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                                border="0">
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:0px 10px 30px 30px;font-family:'Open Sans',sans-serif;"
                                                            align="left">

                                                            <table height="0px" align="left" border="0"
                                                                cellpadding="0" cellspacing="0" width="65%"
                                                                style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 3px solid #011b8f;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                                                <tbody>
                                                                    <tr style="vertical-align: top">
                                                                        <td
                                ...
                                <div class="u-col u-col-41p83"
                                    style="max-width: 320px;min-width: 250.98px;display: table-cell;vertical-align: top;">
                                    <div
                                        style="background-color: #ffffff;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            ...
                                            <table id="u_content_image_3" style="font-family:'Open Sans',sans-serif;"
                                                role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                                border="0">
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:80px 30px 10px 10px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="right" border="0"
                                                                            src="https://cdn.templates.unlayer.com/assets/1678093221272-5daab5a98bfff67898127df6_dark_logo_transparent@2x.png"
                                                                            alt="image" title="image"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 15%;max-width: 31.65px;"
                                                                            width="31.65"
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_text_2" style="font-family:'Open Sans',sans-serif;"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:30px 40px 10px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://cdn.templates.unlayer.com/assets/1678092790327-Asset%203.png"
                                                                            alt="image" title="image"
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_heading_2"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:55px 10px 0px;font-family:'Open Sans',sans-serif;"
                                                            align="left">

                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: 'Open Sans',sans-serif; font-size: 22px; ">
                                                                <strong>Scarlett John</strong></h1>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                style="color: #3d3d3d; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-family: 'Open Sans', sans-serif; font-size: 14px; line-height: 19.6px;">Financial
                                                                        Lawyer|<strong>Law office of Peter
                                                                            Chase</strong></span></p>
                                                            </div>
                                                                    ...
                                                                    <table align="left" border="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://hu.pinterest.com/unlayer/"
                                                                                        title="Pinterest"
                                                                                        target="_blank">
                                                                                        <img src="https://cdn.tools.unlayer.com/social/icons/circle-black/pinterest.png"
                                                                                            alt="Pinterest"
                                                                                            title="Pinterest"
                                                                                            width="32"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important">
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align v-font-size"
                                                                style="color: #3d3d3d; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-family: 'Open Sans', sans-serif; font-size: 14px; line-height: 19.6px;">+123
                                                                        456 7890  |  admin@crownagent.org</span></p>
                                                            </div>
