<x-app-layout background="bg-white">
    <div class="lg:relative lg:flex">
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div class="mb-5">
                <ul class="flex flex-wrap -m-1">
                    <li class="m-1">
                        <a href="" class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-transparent shadow-sm bg-indigo-500 text-white duration-150 ease-in-out">View All</a>
                    </li>
                    <li class="m-1">
                        <a href="" class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-slate-200 hover:border-slate-300 shadow-sm bg-white text-slate-500 duration-150 ease-in-out">Physical Cards</a>
                    </li>
                    <li class="m-1">
                        <a href="" class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-slate-200 hover:border-slate-300 shadow-sm bg-white text-slate-500 duration-150 ease-in-out">Virtual Cards</a>
                    </li>
                </ul>
            </div>
                ...
                <label class="relative block cursor-pointer text-left w-full">
                    ...
                    <div class="p-4 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                        <div class="grid grid-cols-12 items-center gap-x-2">
                            ...
                            <!-- Card status -->
                            <div class="col-span-6 order-2 sm:order-none sm:col-span-2 text-right lg:sidebar-expanded:hidden xl:sidebar-expanded:block">
                                <div class="text-xs inline-flex font-medium bg-amber-100 text-amber-600 rounded-full text-center px-2.5 py-1">Blocked</div>
                            </div>
                        </div>
                    </div>
                    <div class="absolute inset-0 border-2 border-transparent peer-checked:border-indigo-400 rounded pointer-events-none" aria-hidden="true"></div>
        ...
        <!-- Sidebar -->
        {{-- <div>
            <div class="lg:sticky lg:top-16 bg-slate-50 lg:overflow-x-hidden lg:overflow-y-auto no-scrollbar lg:shrink-0 border-t lg:border-t-0 lg:border-l border-slate-200 lg:w-[390px] lg:h-[calc(100vh-64px)]">
                <div class="py-8 px-4 lg:px-8">
                    <div class="max-w-sm mx-auto lg:max-w-none">

                        <div class="text-slate-800 font-semibold text-center mb-6">Physical Metal Card Summary</div>
                        ...
                        <div class="mt-6">
                            ...
                            <ul>
                                <li class="flex items-center justify-between py-3 border-b border-slate-200">
                                    ...
                                    <div class="text-sm font-medium text-slate-800 ml-2">Physical Metal Card</div>
                                </li>
                                <li class="flex items-center justify-between py-3 border-b border-slate-200">
