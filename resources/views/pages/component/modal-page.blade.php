                    ...
                    <div class="flex flex-wrap items-center -m-1.5">
                                        ...
                                        <div class="px-5 py-4">
                                            <div class="flex flex-wrap justify-end space-x-2">
                                                <button
                                                    ...
                                                    @click="modalOpen = false"
                                                >Close</button>
                                                <button class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white">I
                                                    Understand</button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="m-1.5">
                            ...
                            <div x-data="{ modalOpen: false }">
                                ...
                                >
                                    <div
                                        class="bg-white rounded shadow-lg overflow-auto max-w-lg w-full max-h-[400px]"
                                        @click.outside="modalOpen = false"
                                        @keydown.escape.window="modalOpen = false"
                                    >
                                        <!-- Modal header -->
                                            ...
                                            <div class="text-sm">
                                                ...
                                                <div class="space-y-2">
                                                    ...
                                                    <p>Duis aute irure dolor in reprehenderit in voluptate velit esse
                                                        ...
                                                        cupidatat non proident, sunt in culpa qui officia deserunt
                                                        mollit anim id est laborum.</p>
                                                    <p>Ullamcorper malesuada proin libero nunc consequat interdum varius
                                                        sit. Nec sagittis aliquam malesuada bibendum arcu vitae
                                ...
                                >
                                    ...
                                    >
                                        <div class="p-5">
                                            ...
                                            <div class="mb-2">
                                                <div class="flex justify-between items-center">
                                                    <div class="text-lg font-semibold text-slate-800">We use cookies 🍪
                                                    </div>
                                                    <button
                                                        class="text-slate-400 hover:text-slate-500"
                                                        @click="modalOpen = false"
                                    ...
                                    >
                                        <div class="p-5 flex space-x-4">
                                            ...
                                            <div>
                                                <!-- Modal header -->
                                                <div class="mb-2">
                                                    <div class="text-lg font-semibold text-slate-800">Upgrade your
                                                        Subscription?</div>
                                                </div>
                                                <!-- Modal content -->
                                                <div class="text-sm mb-10">
                                                    <div class="space-y-2">
                                                        <p>Semper eget duis at tellus at urna condimentum mattis
                                                            pellentesque lacus suspendisse faucibus interdum.</p>
                                                    </div>
                                                </div>
                                                <!-- Modal footer -->
                                                <div class="flex flex-wrap justify-end space-x-2">
                                                    ...
                                                    >Cancel</button>
                                                    <button
                                                        class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white">Yes,
                                                        Upgrade it</button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    >
                                        <div class="p-5 flex space-x-4">
                                            ...
                                            <div>
                                                <!-- Modal header -->
                                                <div class="mb-2">
                                                    <div class="text-lg font-semibold text-slate-800">Delete 1 customer?
                                                    </div>
                                                </div>
                                                <!-- Modal content -->
                                                <div class="text-sm mb-10">
                                                ...
                                                <div class="flex flex-wrap justify-end space-x-2">
                                                    <button
                                                        ...
                                                        @click="modalOpen = false"
                                                    >Cancel</button>
                                                    <button class="btn-sm bg-rose-500 hover:bg-rose-600 text-white">Yes,
                                                        Delete it</button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div class="p-5 flex space-x-4">
                                            <!-- Icon -->
                                            <div
                                                class="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-indigo-100">
                                                <svg
                                            ...
                                            <div>
                                                <!-- Modal header -->
                                                <div class="mb-2">
                                                    <div class="text-lg font-semibold text-slate-800">Create new Event?
                                                    </div>
                                                </div>
                                                <!-- Modal content -->
                                                <div class="text-sm mb-10">
                            ...
                            <div x-data="{ modalOpen: false }">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="px-5 py-4">
                                            <div class="text-sm">
                                                <div class="font-medium text-slate-800 mb-3">Let us know what you think
                                                    🙌</div>
                                            </div>
                                            <div class="space-y-3">
                                                <div>
                                        ...
                                        <div class="px-5 py-4 border-t border-slate-200">
                                            <div class="flex flex-wrap justify-end space-x-2">
                                                ...
                                                >Cancel</button>
                                                <button
                                                    class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white">Send</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="p-6">
                                            <div class="relative">
                                                ...
                                                <div class="mb-2 text-center">
                                                    ...
                                                    <div class="text-lg font-semibold text-slate-800">Subscribe to the
                                                        Newsletter!</div>
                                                </div>
                                                <!-- Modal content -->
                                            ...
                                            <div class="relative">
                                                ...
                                                <div class="mb-2 text-center">
                                                    ...
                                                    <div class="inline-flex mb-2">
                                                        <img
                                                            src="{{ asset('images/announcement-icon.svg') }}"
                                                            width="80"
                                                            height="80"
                                                            alt="Announcement"
                                                        />
                                                    </div>
                                                    <div class="text-lg font-semibold text-slate-800">You Unlocked Level
                                                        2!</div>
                                                </div>
                                                <!-- Modal content -->
                                                <div class="text-center">
                                        ...
                                        <div class="p-6">
                                            <div class="relative">
                                                ...
                                                <div class="mb-5 text-center">
                                                    ...
                                                    <div class="text-lg font-semibold text-slate-800">Connect Mosaic
                                                        with your Cruip account</div>
                                                </div>
                                                <!-- Modal content -->
                                                <div class="text-sm mb-5">
                                                    <div class="font-medium text-slate-800 mb-3">Mosaic would like to:
                                                    </div>
                                                    ...
                                                    <div class="text-xs text-slate-500">By clicking on Allow access, you
                                                        authorize Mosaic to use your information in accordance with its
                                                        <a
                                                            class="text-indigo-500 hover:text-indigo-600"
                                                            href="#0"
                                                        >Privacy Policy</a>. You can stop it at any time on the
                                                        integrations page of your Mosaic account.</div>
                                                </div>
                                                <!-- Modal footer -->
                                                <div class="flex flex-wrap justify-end space-x-2">
                                                    <button
                                                    ...
                                                    >Cancel</button>
                                                    <button
                                                        class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white">Allow
                                                        Access</button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <div class="relative">
                                            <img
                                                class="w-full"
                                                src="{{ asset('images/modal-image.jpg') }}"
                                                width="460"
                                                height="200"
                                                alt="New on Mosaic"
                                            />
                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="text-lg font-semibold text-slate-800">Help your team work
                                                    faster with X 🏃‍♂️</div>
                                            </div>
                                            <!-- Modal content -->
                                            <div class="text-sm mb-5">
                                                <div class="space-y-2">
                                                    <p>You might not be aware of this fact, but every frame, digital
                                                        video, canvas, responsive design, and image often has a
                                                        rectangular shape that is exceptionally precise in proportion
                                                        (or ratio).</p>
                                                    <p>The ratio has to be well-defined to make shapes fit into
                                                        different and distinct mediums, such as computer, movies,
                                                        television and camera screens.</p>
                                                </div>
                                            </div>
                                            <!-- Modal footer -->
                                            <div class="flex flex-wrap justify-end space-x-2">
                                    ...
                                    >
                                        ...
                                        <div class="px-5 pt-4 pb-1">
                                            <div class="text-sm">
                                                    ...
                                                    <li>
                                                        ...
                                                        >
                                                            <div class="flex items-center">
                                                                <div
                                                                    class="w-4 h-4 border-4 border-indigo-500 rounded-full mr-3">
                                                                </div>
                                                                <div class="grow">
                                                                    <div
                                                                        class="flex flex-wrap items-center justify-between mb-0.5">
                                                                        <span class="font-medium text-slate-800">Mosaic
                                                                            Light <span
                                                                                class="text-xs italic text-slate-500 align-top"
                                                                            >Current Plan</span></span>
                                                                        <span><span
                                                                                class="font-medium text-emerald-600">$39.00</span>/mo</span>
                                                                    </div>
                                                                    <div class="text-sm">2 MB · 1 member · 500 block
                                                                        limits</div>
                                                                </div>
                                                            </div>
                                                        </button>
                                                            ...
                                                            <div class="flex items-center">
                                                                ...
                                                                <div class="grow">
                                                                    <div
                                                                        class="flex flex-wrap items-center justify-between mb-0.5">
                                                                        <span
                                                                            class="font-semibold text-slate-800">Mosaic
                                                                            Basic <span
                                                                                class="text-xs italic text-indigo-500 align-top"
                                                                            >Best Value ✨</span></span>
                                                                        <span><span
                                                                                class="font-medium text-emerald-600">$59.00</span>/mo</span>
                                                                    </div>
                                                                    <div class="text-sm">5 MB · 2 members · 1000 block
                                                                        limits</div>
                                                                </div>
                                                            </div>
                                                        </button>
                                                                ...
                                                                <div class="grow">
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            Plus</span>
                                                                        <span><span
                                                                                class="font-medium text-emerald-600">$79.00</span>/mo</span>
                                                                    </div>
                                                                    <div class="text-sm">10 MB · 5 members · Unlimited
                                                                        block limits</div>
                                                                </div>
                                                            </div>
                                                        </button>
                                                ...
                                                <div class="text-xs text-slate-500">Your workspace’s Mosaic Light Plan
                                                    is set to $39 per month and will renew on August 9, 2021.</div>
                                            </div>
                                        </div>
                                        <!-- Modal footer -->
                                        <div class="px-5 py-4">
                                            <div class="flex flex-wrap justify-end space-x-2">
                                                ...
                                                >Cancel</button>
                                                <button
                                                    class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white">Change
                                                    Plan</button>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <li>
                                                        ...
                                                        >
                                                            ...
                                                            <span><span
                                                                ...
                                                                >Messages</span> - Conversation / … / Mike Mills</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a
                                                        ...
                                                        >
                                                            ...
                                                            <span><span
                                                                    class="font-medium text-slate-800 group-hover:text-white"
                                                                >Messages</span> - Conversation / … / Eva Patrick</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
